...
I have parametrically modelled the case after my own hand, as my height of 1.7m is world's average. This guide is based on EVK version 1.2.  
...
Position the thumb keys in "ASM_ThumbPlate.prt".  
